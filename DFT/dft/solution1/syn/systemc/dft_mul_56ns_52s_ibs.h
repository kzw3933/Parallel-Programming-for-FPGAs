...
// ==============================================================
#ifndef __dft_mul_56ns_52s_ibs__HH__
#define __dft_mul_56ns_52s_ibs__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(dft_mul_56ns_52s_ibs) {
    ...
    SC_CTOR(dft_mul_56ns_52s_ibs):  ACMP_mul_us_U ("ACMP_mul_us_U") {
