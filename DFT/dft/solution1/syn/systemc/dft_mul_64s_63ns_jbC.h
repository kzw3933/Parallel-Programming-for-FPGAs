...
// ==============================================================
#ifndef __dft_mul_64s_63ns_jbC__HH__
#define __dft_mul_64s_63ns_jbC__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(dft_mul_64s_63ns_jbC) {
    ...
    SC_CTOR(dft_mul_64s_63ns_jbC):  ACMP_mul_su_U ("ACMP_mul_su_U") {
