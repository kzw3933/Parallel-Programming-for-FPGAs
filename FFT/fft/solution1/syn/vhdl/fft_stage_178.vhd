...
architecture behav of fft_stage_178 is 
    ...
    signal j_fu_306_p2 : STD_LOGIC_VECTOR (1 downto 0);
    signal j_reg_360 : STD_LOGIC_VECTOR (1 downto 0);
    ...
    signal i_11_fu_346_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal i_11_reg_448 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal tmp_19_fu_312_p4 : STD_LOGIC_VECTOR (21 downto 0);
...
begin
    ...
    fft_faddfsub_32nslbW_U48 : component fft_faddfsub_32nslbW
    generic map (
        ID => 1,
        NUM_STAGE => 4,
        din0_WIDTH => 32,
    ...
    fft_faddfsub_32nslbW_U49 : component fft_faddfsub_32nslbW
    generic map (
        ID => 1,
        NUM_STAGE => 4,
        din0_WIDTH => 32,
    ...
    fft_fadd_32ns_32nmb6_U50 : component fft_fadd_32ns_32nmb6
    generic map (
        ID => 1,
        NUM_STAGE => 4,
        din0_WIDTH => 32,
    ...
    fft_fadd_32ns_32nmb6_U51 : component fft_fadd_32ns_32nmb6
    generic map (
        ID => 1,
        NUM_STAGE => 4,
        din0_WIDTH => 32,
    ...
    fft_fmul_32ns_32nncg_U52 : component fft_fmul_32ns_32nncg
    generic map (
        ID => 1,
        NUM_STAGE => 3,
        din0_WIDTH => 32,
    ...
    fft_fmul_32ns_32nncg_U53 : component fft_fmul_32ns_32nncg
    generic map (
        ID => 1,
        NUM_STAGE => 3,
        din0_WIDTH => 32,
    ...
    fft_fmul_32ns_32nncg_U54 : component fft_fmul_32ns_32nncg
    generic map (
        ID => 1,
        NUM_STAGE => 3,
        din0_WIDTH => 32,
    ...
    fft_fptrunc_64ns_ocq_U55 : component fft_fptrunc_64ns_ocq
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 64,
    ...
    fft_fptrunc_64ns_ocq_U56 : component fft_fptrunc_64ns_ocq
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 64,
    ...
    fft_fpext_32ns_64pcA_U57 : component fft_fpext_32ns_64pcA
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 32,
        ...
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state2)) then
                j_reg_360 <= j_fu_306_p2;
                    zext_ln39_reg_352(1 downto 0) <= zext_ln39_fu_296_p1(1 downto 0);
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    zext_ln39_reg_352(31 downto 2) <= "000000000000000000000000000000";
    ...
    Out_I_2_address0 <= sext_ln48_reg_400(10 - 1 downto 0);
    Out_I_2_address1 <= sext_ln50_reg_432(10 - 1 downto 0);

    Out_I_2_ce0_assign_proc : process(ap_CS_fsm_state21)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state21)) then 
    ...
    Out_I_2_ce1_assign_proc : process(ap_CS_fsm_state21)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state21)) then 
    ...
    Out_I_2_d0 <= reg_289;
    Out_I_2_d1 <= tmp_5_reg_458;

    Out_I_2_we0_assign_proc : process(ap_CS_fsm_state21)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state21)) then 
    ...
    Out_I_2_we1_assign_proc : process(ap_CS_fsm_state21)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state21)) then 
    ...
    Out_R_2_address0 <= sext_ln48_reg_400(10 - 1 downto 0);
    Out_R_2_address1 <= sext_ln50_reg_432(10 - 1 downto 0);

    Out_R_2_ce0_assign_proc : process(ap_CS_fsm_state21)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state21)) then 
    ...
    Out_R_2_ce1_assign_proc : process(ap_CS_fsm_state21)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state21)) then 
    ...
    Out_R_2_d0 <= reg_282;
    Out_R_2_d1 <= tmp_6_reg_453;

    Out_R_2_we0_assign_proc : process(ap_CS_fsm_state21)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state21)) then 
    ...
    Out_R_2_we1_assign_proc : process(ap_CS_fsm_state21)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state21)) then 
    ...
    X_I_1_address0_assign_proc : process(sext_ln48_fu_334_p1, ap_CS_fsm_state8, sext_ln50_fu_340_p1, ap_CS_fsm_state15)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state15)) then 
            X_I_1_address0 <= sext_ln50_fu_340_p1(10 - 1 downto 0);
        elsif ((ap_const_logic_1 = ap_CS_fsm_state8)) then 
            X_I_1_address0 <= sext_ln48_fu_334_p1(10 - 1 downto 0);
        else 
    ...
    X_I_1_ce0_assign_proc : process(ap_CS_fsm_state8, ap_CS_fsm_state15)
    begin
    ...
    X_R_1_address0_assign_proc : process(sext_ln48_fu_334_p1, ap_CS_fsm_state8, sext_ln50_fu_340_p1, ap_CS_fsm_state15)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state15)) then 
            X_R_1_address0 <= sext_ln50_fu_340_p1(10 - 1 downto 0);
        elsif ((ap_const_logic_1 = ap_CS_fsm_state8)) then 
            X_R_1_address0 <= sext_ln48_fu_334_p1(10 - 1 downto 0);
        else 
    ...
    X_R_1_ce0_assign_proc : process(ap_CS_fsm_state8, ap_CS_fsm_state15)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state15) or (ap_const_logic_1 = ap_CS_fsm_state8))) then 
    ...
    i_11_fu_346_p2 <= std_logic_vector(signed(i_0_reg_179) + signed(ap_const_lv32_4));
    i_lower_fu_328_p2 <= std_logic_vector(signed(i_0_reg_179) + signed(ap_const_lv32_2));
    icmp_ln39_fu_300_p2 <= "1" when (i_reg_168 = ap_const_lv2_2) else "0";
    icmp_ln46_fu_322_p2 <= "1" when (signed(tmp_19_fu_312_p4) < signed(ap_const_lv22_1)) else "0";
    j_fu_306_p2 <= std_logic_vector(unsigned(i_reg_168) + unsigned(ap_const_lv2_1));
    ...
    tmp_19_fu_312_p4 <= i_0_reg_179(31 downto 10);
