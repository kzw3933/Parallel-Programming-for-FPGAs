...
architecture behav of fft_stage_183 is 
    ...
    constant ap_const_lv32_BD490FDB : STD_LOGIC_VECTOR (31 downto 0) := "10111101010010010000111111011011";
    ...
    signal j_fu_306_p2 : STD_LOGIC_VECTOR (6 downto 0);
    signal j_reg_360 : STD_LOGIC_VECTOR (6 downto 0);
    ...
    signal i_6_fu_346_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal i_6_reg_448 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal tmp_4_reg_458 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal tmp_14_fu_312_p4 : STD_LOGIC_VECTOR (21 downto 0);
...
begin
    ...
    fft_faddfsub_32nslbW_U118 : component fft_faddfsub_32nslbW
    generic map (
        ID => 1,
        NUM_STAGE => 4,
        din0_WIDTH => 32,
    ...
    fft_faddfsub_32nslbW_U119 : component fft_faddfsub_32nslbW
    generic map (
        ID => 1,
        NUM_STAGE => 4,
        din0_WIDTH => 32,
    ...
    fft_fadd_32ns_32nmb6_U120 : component fft_fadd_32ns_32nmb6
    generic map (
        ID => 1,
        NUM_STAGE => 4,
        din0_WIDTH => 32,
    ...
    fft_fadd_32ns_32nmb6_U121 : component fft_fadd_32ns_32nmb6
    generic map (
        ID => 1,
        NUM_STAGE => 4,
        din0_WIDTH => 32,
    ...
    fft_fmul_32ns_32nncg_U122 : component fft_fmul_32ns_32nncg
    generic map (
        ID => 1,
        NUM_STAGE => 3,
        din0_WIDTH => 32,
    ...
    fft_fmul_32ns_32nncg_U123 : component fft_fmul_32ns_32nncg
    generic map (
        ID => 1,
        NUM_STAGE => 3,
        din0_WIDTH => 32,
    ...
    fft_fmul_32ns_32nncg_U124 : component fft_fmul_32ns_32nncg
    generic map (
        ID => 1,
        NUM_STAGE => 3,
        din0_WIDTH => 32,
    ...
    fft_fptrunc_64ns_ocq_U125 : component fft_fptrunc_64ns_ocq
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 64,
    ...
    fft_fptrunc_64ns_ocq_U126 : component fft_fptrunc_64ns_ocq
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 64,
    ...
    fft_fpext_32ns_64pcA_U127 : component fft_fpext_32ns_64pcA
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 32,
        ...
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state2)) then
                j_reg_360 <= j_fu_306_p2;
                    zext_ln39_reg_352(6 downto 0) <= zext_ln39_fu_296_p1(6 downto 0);
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    zext_ln39_reg_352(31 downto 7) <= "0000000000000000000000000";
    ...
    Out_I_7_address0 <= sext_ln48_reg_400(10 - 1 downto 0);
    Out_I_7_address1 <= sext_ln50_reg_432(10 - 1 downto 0);

    Out_I_7_ce0_assign_proc : process(ap_CS_fsm_state21)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state21)) then 
    ...
    Out_I_7_ce1_assign_proc : process(ap_CS_fsm_state21)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state21)) then 
    ...
    Out_I_7_d0 <= reg_289;
    Out_I_7_d1 <= tmp_4_reg_458;

    Out_I_7_we0_assign_proc : process(ap_CS_fsm_state21)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state21)) then 
    ...
    Out_I_7_we1_assign_proc : process(ap_CS_fsm_state21)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state21)) then 
    ...
    Out_R_7_address0 <= sext_ln48_reg_400(10 - 1 downto 0);
    Out_R_7_address1 <= sext_ln50_reg_432(10 - 1 downto 0);

    Out_R_7_ce0_assign_proc : process(ap_CS_fsm_state21)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state21)) then 
    ...
    Out_R_7_ce1_assign_proc : process(ap_CS_fsm_state21)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state21)) then 
    ...
    Out_R_7_d0 <= reg_282;
    Out_R_7_d1 <= tmp_6_reg_453;

    Out_R_7_we0_assign_proc : process(ap_CS_fsm_state21)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state21)) then 
    ...
    Out_R_7_we1_assign_proc : process(ap_CS_fsm_state21)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state21)) then 
    ...
    X_I_6_address0_assign_proc : process(sext_ln48_fu_334_p1, ap_CS_fsm_state8, sext_ln50_fu_340_p1, ap_CS_fsm_state15)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state15)) then 
            X_I_6_address0 <= sext_ln50_fu_340_p1(10 - 1 downto 0);
        elsif ((ap_const_logic_1 = ap_CS_fsm_state8)) then 
            X_I_6_address0 <= sext_ln48_fu_334_p1(10 - 1 downto 0);
        else 
    ...
    X_I_6_ce0_assign_proc : process(ap_CS_fsm_state8, ap_CS_fsm_state15)
    begin
    ...
    X_R_6_address0_assign_proc : process(sext_ln48_fu_334_p1, ap_CS_fsm_state8, sext_ln50_fu_340_p1, ap_CS_fsm_state15)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state15)) then 
            X_R_6_address0 <= sext_ln50_fu_340_p1(10 - 1 downto 0);
        elsif ((ap_const_logic_1 = ap_CS_fsm_state8)) then 
            X_R_6_address0 <= sext_ln48_fu_334_p1(10 - 1 downto 0);
        else 
    ...
    X_R_6_ce0_assign_proc : process(ap_CS_fsm_state8, ap_CS_fsm_state15)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state15) or (ap_const_logic_1 = ap_CS_fsm_state8))) then 
    ...
    i_6_fu_346_p2 <= std_logic_vector(signed(i_0_reg_179) + signed(ap_const_lv32_80));
    i_lower_fu_328_p2 <= std_logic_vector(signed(i_0_reg_179) + signed(ap_const_lv32_40));
    icmp_ln39_fu_300_p2 <= "1" when (i_reg_168 = ap_const_lv7_40) else "0";
    icmp_ln46_fu_322_p2 <= "1" when (signed(tmp_14_fu_312_p4) < signed(ap_const_lv22_1)) else "0";
    j_fu_306_p2 <= std_logic_vector(unsigned(i_reg_168) + unsigned(ap_const_lv7_1));
    ...
    tmp_14_fu_312_p4 <= i_0_reg_179(31 downto 10);
