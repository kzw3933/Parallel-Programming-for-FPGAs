...
architecture behav of fft_stage_185 is 
    ...
    constant ap_const_lv32_BC490FDB : STD_LOGIC_VECTOR (31 downto 0) := "10111100010010010000111111011011";
    ...
    signal j_fu_306_p2 : STD_LOGIC_VECTOR (8 downto 0);
    signal j_reg_360 : STD_LOGIC_VECTOR (8 downto 0);
    ...
    signal i_4_fu_346_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal i_4_reg_448 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal tmp_2_reg_458 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal i_reg_168 : STD_LOGIC_VECTOR (8 downto 0);
    ...
    signal tmp_12_fu_312_p4 : STD_LOGIC_VECTOR (21 downto 0);
...
begin
    ...
    fft_faddfsub_32nslbW_U146 : component fft_faddfsub_32nslbW
    generic map (
        ID => 1,
        NUM_STAGE => 4,
        din0_WIDTH => 32,
    ...
    fft_faddfsub_32nslbW_U147 : component fft_faddfsub_32nslbW
    generic map (
        ID => 1,
        NUM_STAGE => 4,
        din0_WIDTH => 32,
    ...
    fft_fadd_32ns_32nmb6_U148 : component fft_fadd_32ns_32nmb6
    generic map (
        ID => 1,
        NUM_STAGE => 4,
        din0_WIDTH => 32,
    ...
    fft_fadd_32ns_32nmb6_U149 : component fft_fadd_32ns_32nmb6
    generic map (
        ID => 1,
        NUM_STAGE => 4,
        din0_WIDTH => 32,
    ...
    fft_fmul_32ns_32nncg_U150 : component fft_fmul_32ns_32nncg
    generic map (
        ID => 1,
        NUM_STAGE => 3,
        din0_WIDTH => 32,
    ...
    fft_fmul_32ns_32nncg_U151 : component fft_fmul_32ns_32nncg
    generic map (
        ID => 1,
        NUM_STAGE => 3,
        din0_WIDTH => 32,
    ...
    fft_fmul_32ns_32nncg_U152 : component fft_fmul_32ns_32nncg
    generic map (
        ID => 1,
        NUM_STAGE => 3,
        din0_WIDTH => 32,
    ...
    fft_fptrunc_64ns_ocq_U153 : component fft_fptrunc_64ns_ocq
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 64,
    ...
    fft_fptrunc_64ns_ocq_U154 : component fft_fptrunc_64ns_ocq
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 64,
    ...
    fft_fpext_32ns_64pcA_U155 : component fft_fpext_32ns_64pcA
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 32,
        ...
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state2)) then
                j_reg_360 <= j_fu_306_p2;
                    zext_ln39_reg_352(8 downto 0) <= zext_ln39_fu_296_p1(8 downto 0);
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    zext_ln39_reg_352(31 downto 9) <= "00000000000000000000000";
    ...
    Out_I_9_address0 <= sext_ln48_reg_400(10 - 1 downto 0);
    Out_I_9_address1 <= sext_ln50_reg_432(10 - 1 downto 0);

    Out_I_9_ce0_assign_proc : process(ap_CS_fsm_state21)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state21)) then 
    ...
    Out_I_9_ce1_assign_proc : process(ap_CS_fsm_state21)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state21)) then 
    ...
    Out_I_9_d0 <= reg_289;
    Out_I_9_d1 <= tmp_2_reg_458;

    Out_I_9_we0_assign_proc : process(ap_CS_fsm_state21)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state21)) then 
    ...
    Out_I_9_we1_assign_proc : process(ap_CS_fsm_state21)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state21)) then 
    ...
    Out_R_9_address0 <= sext_ln48_reg_400(10 - 1 downto 0);
    Out_R_9_address1 <= sext_ln50_reg_432(10 - 1 downto 0);

    Out_R_9_ce0_assign_proc : process(ap_CS_fsm_state21)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state21)) then 
    ...
    Out_R_9_ce1_assign_proc : process(ap_CS_fsm_state21)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state21)) then 
    ...
    Out_R_9_d0 <= reg_282;
    Out_R_9_d1 <= tmp_6_reg_453;

    Out_R_9_we0_assign_proc : process(ap_CS_fsm_state21)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state21)) then 
    ...
    Out_R_9_we1_assign_proc : process(ap_CS_fsm_state21)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state21)) then 
    ...
    X_I_8_address0_assign_proc : process(sext_ln48_fu_334_p1, ap_CS_fsm_state8, sext_ln50_fu_340_p1, ap_CS_fsm_state15)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state15)) then 
            X_I_8_address0 <= sext_ln50_fu_340_p1(10 - 1 downto 0);
        elsif ((ap_const_logic_1 = ap_CS_fsm_state8)) then 
            X_I_8_address0 <= sext_ln48_fu_334_p1(10 - 1 downto 0);
        else 
    ...
    X_I_8_ce0_assign_proc : process(ap_CS_fsm_state8, ap_CS_fsm_state15)
    begin
    ...
    X_R_8_address0_assign_proc : process(sext_ln48_fu_334_p1, ap_CS_fsm_state8, sext_ln50_fu_340_p1, ap_CS_fsm_state15)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state15)) then 
            X_R_8_address0 <= sext_ln50_fu_340_p1(10 - 1 downto 0);
        elsif ((ap_const_logic_1 = ap_CS_fsm_state8)) then 
            X_R_8_address0 <= sext_ln48_fu_334_p1(10 - 1 downto 0);
        else 
    ...
    X_R_8_ce0_assign_proc : process(ap_CS_fsm_state8, ap_CS_fsm_state15)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state15) or (ap_const_logic_1 = ap_CS_fsm_state8))) then 
    ...
    i_4_fu_346_p2 <= std_logic_vector(signed(i_0_reg_179) + signed(ap_const_lv32_200));
    i_lower_fu_328_p2 <= std_logic_vector(signed(i_0_reg_179) + signed(ap_const_lv32_100));
    icmp_ln39_fu_300_p2 <= "1" when (i_reg_168 = ap_const_lv9_100) else "0";
    icmp_ln46_fu_322_p2 <= "1" when (signed(tmp_12_fu_312_p4) < signed(ap_const_lv22_1)) else "0";
    j_fu_306_p2 <= std_logic_vector(unsigned(i_reg_168) + unsigned(ap_const_lv9_1));
    ...
    tmp_12_fu_312_p4 <= i_0_reg_179(31 downto 10);
