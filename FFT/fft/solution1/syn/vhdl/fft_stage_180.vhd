...
architecture behav of fft_stage_180 is 
    ...
    constant ap_const_lv32_BEC90FDB : STD_LOGIC_VECTOR (31 downto 0) := "10111110110010010000111111011011";
    ...
    signal j_fu_306_p2 : STD_LOGIC_VECTOR (3 downto 0);
    signal j_reg_360 : STD_LOGIC_VECTOR (3 downto 0);
    ...
    signal i_9_fu_346_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal i_9_reg_448 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal tmp_17_fu_312_p4 : STD_LOGIC_VECTOR (21 downto 0);
...
begin
    ...
    fft_faddfsub_32nslbW_U76 : component fft_faddfsub_32nslbW
    generic map (
        ID => 1,
        NUM_STAGE => 4,
        din0_WIDTH => 32,
    ...
    fft_faddfsub_32nslbW_U77 : component fft_faddfsub_32nslbW
    generic map (
        ID => 1,
        NUM_STAGE => 4,
        din0_WIDTH => 32,
    ...
    fft_fadd_32ns_32nmb6_U78 : component fft_fadd_32ns_32nmb6
    generic map (
        ID => 1,
        NUM_STAGE => 4,
        din0_WIDTH => 32,
    ...
    fft_fadd_32ns_32nmb6_U79 : component fft_fadd_32ns_32nmb6
    generic map (
        ID => 1,
        NUM_STAGE => 4,
        din0_WIDTH => 32,
    ...
    fft_fmul_32ns_32nncg_U80 : component fft_fmul_32ns_32nncg
    generic map (
        ID => 1,
        NUM_STAGE => 3,
        din0_WIDTH => 32,
    ...
    fft_fmul_32ns_32nncg_U81 : component fft_fmul_32ns_32nncg
    generic map (
        ID => 1,
        NUM_STAGE => 3,
        din0_WIDTH => 32,
    ...
    fft_fmul_32ns_32nncg_U82 : component fft_fmul_32ns_32nncg
    generic map (
        ID => 1,
        NUM_STAGE => 3,
        din0_WIDTH => 32,
    ...
    fft_fptrunc_64ns_ocq_U83 : component fft_fptrunc_64ns_ocq
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 64,
    ...
    fft_fptrunc_64ns_ocq_U84 : component fft_fptrunc_64ns_ocq
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 64,
    ...
    fft_fpext_32ns_64pcA_U85 : component fft_fpext_32ns_64pcA
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 32,
        ...
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state2)) then
                j_reg_360 <= j_fu_306_p2;
                    zext_ln39_reg_352(3 downto 0) <= zext_ln39_fu_296_p1(3 downto 0);
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    zext_ln39_reg_352(31 downto 4) <= "0000000000000000000000000000";
    ...
    Out_I_4_address0 <= sext_ln48_reg_400(10 - 1 downto 0);
    Out_I_4_address1 <= sext_ln50_reg_432(10 - 1 downto 0);

    Out_I_4_ce0_assign_proc : process(ap_CS_fsm_state21)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state21)) then 
    ...
    Out_I_4_ce1_assign_proc : process(ap_CS_fsm_state21)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state21)) then 
    ...
    Out_I_4_d0 <= reg_289;
    Out_I_4_d1 <= tmp_3_reg_458;

    Out_I_4_we0_assign_proc : process(ap_CS_fsm_state21)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state21)) then 
    ...
    Out_I_4_we1_assign_proc : process(ap_CS_fsm_state21)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state21)) then 
    ...
    Out_R_4_address0 <= sext_ln48_reg_400(10 - 1 downto 0);
    Out_R_4_address1 <= sext_ln50_reg_432(10 - 1 downto 0);

    Out_R_4_ce0_assign_proc : process(ap_CS_fsm_state21)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state21)) then 
    ...
    Out_R_4_ce1_assign_proc : process(ap_CS_fsm_state21)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state21)) then 
    ...
    Out_R_4_d0 <= reg_282;
    Out_R_4_d1 <= tmp_6_reg_453;

    Out_R_4_we0_assign_proc : process(ap_CS_fsm_state21)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state21)) then 
    ...
    Out_R_4_we1_assign_proc : process(ap_CS_fsm_state21)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state21)) then 
    ...
    X_I_3_address0_assign_proc : process(sext_ln48_fu_334_p1, ap_CS_fsm_state8, sext_ln50_fu_340_p1, ap_CS_fsm_state15)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state15)) then 
            X_I_3_address0 <= sext_ln50_fu_340_p1(10 - 1 downto 0);
        elsif ((ap_const_logic_1 = ap_CS_fsm_state8)) then 
            X_I_3_address0 <= sext_ln48_fu_334_p1(10 - 1 downto 0);
        else 
    ...
    X_I_3_ce0_assign_proc : process(ap_CS_fsm_state8, ap_CS_fsm_state15)
    begin
    ...
    X_R_3_address0_assign_proc : process(sext_ln48_fu_334_p1, ap_CS_fsm_state8, sext_ln50_fu_340_p1, ap_CS_fsm_state15)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state15)) then 
            X_R_3_address0 <= sext_ln50_fu_340_p1(10 - 1 downto 0);
        elsif ((ap_const_logic_1 = ap_CS_fsm_state8)) then 
            X_R_3_address0 <= sext_ln48_fu_334_p1(10 - 1 downto 0);
        else 
    ...
    X_R_3_ce0_assign_proc : process(ap_CS_fsm_state8, ap_CS_fsm_state15)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state15) or (ap_const_logic_1 = ap_CS_fsm_state8))) then 
    ...
    i_9_fu_346_p2 <= std_logic_vector(signed(i_0_reg_179) + signed(ap_const_lv32_10));
    i_lower_fu_328_p2 <= std_logic_vector(signed(i_0_reg_179) + signed(ap_const_lv32_8));
    icmp_ln39_fu_300_p2 <= "1" when (i_reg_168 = ap_const_lv4_8) else "0";
    icmp_ln46_fu_322_p2 <= "1" when (signed(tmp_17_fu_312_p4) < signed(ap_const_lv22_1)) else "0";
    j_fu_306_p2 <= std_logic_vector(unsigned(i_reg_168) + unsigned(ap_const_lv4_1));
    ...
    tmp_17_fu_312_p4 <= i_0_reg_179(31 downto 10);
