...
#ifndef _fft_stage_180_HH_
#define _fft_stage_180_HH_
...
struct fft_stage_180 : public sc_module {
    ...
    sc_out< sc_lv<10> > X_R_3_address0;
    sc_out< sc_logic > X_R_3_ce0;
    sc_in< sc_lv<32> > X_R_3_q0;
    sc_out< sc_lv<10> > X_I_3_address0;
    sc_out< sc_logic > X_I_3_ce0;
    sc_in< sc_lv<32> > X_I_3_q0;
    sc_out< sc_lv<10> > Out_R_4_address0;
    sc_out< sc_logic > Out_R_4_ce0;
    sc_out< sc_logic > Out_R_4_we0;
    sc_out< sc_lv<32> > Out_R_4_d0;
    sc_out< sc_lv<10> > Out_R_4_address1;
    sc_out< sc_logic > Out_R_4_ce1;
    sc_out< sc_logic > Out_R_4_we1;
    sc_out< sc_lv<32> > Out_R_4_d1;
    sc_out< sc_lv<10> > Out_I_4_address0;
    sc_out< sc_logic > Out_I_4_ce0;
    sc_out< sc_logic > Out_I_4_we0;
    sc_out< sc_lv<32> > Out_I_4_d0;
    sc_out< sc_lv<10> > Out_I_4_address1;
    sc_out< sc_logic > Out_I_4_ce1;
    sc_out< sc_logic > Out_I_4_we1;
    sc_out< sc_lv<32> > Out_I_4_d1;
    sc_signal< sc_logic > ap_var_for_const0;


    // Module declarations
    fft_stage_180(sc_module_name name);
    SC_HAS_PROCESS(fft_stage_180);
    ...
    fft_faddfsub_32nslbW<1,4,32,32,32>* fft_faddfsub_32nslbW_U76;
    fft_faddfsub_32nslbW<1,4,32,32,32>* fft_faddfsub_32nslbW_U77;
    fft_fadd_32ns_32nmb6<1,4,32,32,32>* fft_fadd_32ns_32nmb6_U78;
    fft_fadd_32ns_32nmb6<1,4,32,32,32>* fft_fadd_32ns_32nmb6_U79;
    fft_fmul_32ns_32nncg<1,3,32,32,32>* fft_fmul_32ns_32nncg_U80;
    fft_fmul_32ns_32nncg<1,3,32,32,32>* fft_fmul_32ns_32nncg_U81;
    fft_fmul_32ns_32nncg<1,3,32,32,32>* fft_fmul_32ns_32nncg_U82;
    fft_fptrunc_64ns_ocq<1,2,64,32>* fft_fptrunc_64ns_ocq_U83;
    fft_fptrunc_64ns_ocq<1,2,64,32>* fft_fptrunc_64ns_ocq_U84;
    fft_fpext_32ns_64pcA<1,2,32,64>* fft_fpext_32ns_64pcA_U85;
    ...
    sc_signal< sc_lv<4> > j_fu_306_p2;
    sc_signal< sc_lv<4> > j_reg_360;
    ...
    sc_signal< sc_lv<32> > i_9_fu_346_p2;
    sc_signal< sc_lv<32> > i_9_reg_448;
    ...
    sc_signal< sc_lv<22> > tmp_17_fu_312_p4;
    ...
    static const sc_lv<32> ap_const_lv32_BEC90FDB;
    ...
    void thread_Out_I_4_address0();
    void thread_Out_I_4_address1();
    void thread_Out_I_4_ce0();
    void thread_Out_I_4_ce1();
    void thread_Out_I_4_d0();
    void thread_Out_I_4_d1();
    void thread_Out_I_4_we0();
    void thread_Out_I_4_we1();
    void thread_Out_R_4_address0();
    void thread_Out_R_4_address1();
    void thread_Out_R_4_ce0();
    void thread_Out_R_4_ce1();
    void thread_Out_R_4_d0();
    void thread_Out_R_4_d1();
    void thread_Out_R_4_we0();
    void thread_Out_R_4_we1();
    void thread_X_I_3_address0();
    void thread_X_I_3_ce0();
    void thread_X_R_3_address0();
    void thread_X_R_3_ce0();
