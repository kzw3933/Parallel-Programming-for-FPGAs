...
#ifndef _fft_stage_182_HH_
#define _fft_stage_182_HH_
...
struct fft_stage_182 : public sc_module {
    ...
    sc_out< sc_lv<10> > X_R_5_address0;
    sc_out< sc_logic > X_R_5_ce0;
    sc_in< sc_lv<32> > X_R_5_q0;
    sc_out< sc_lv<10> > X_I_5_address0;
    sc_out< sc_logic > X_I_5_ce0;
    sc_in< sc_lv<32> > X_I_5_q0;
    sc_out< sc_lv<10> > Out_R_6_address0;
    sc_out< sc_logic > Out_R_6_ce0;
    sc_out< sc_logic > Out_R_6_we0;
    sc_out< sc_lv<32> > Out_R_6_d0;
    sc_out< sc_lv<10> > Out_R_6_address1;
    sc_out< sc_logic > Out_R_6_ce1;
    sc_out< sc_logic > Out_R_6_we1;
    sc_out< sc_lv<32> > Out_R_6_d1;
    sc_out< sc_lv<10> > Out_I_6_address0;
    sc_out< sc_logic > Out_I_6_ce0;
    sc_out< sc_logic > Out_I_6_we0;
    sc_out< sc_lv<32> > Out_I_6_d0;
    sc_out< sc_lv<10> > Out_I_6_address1;
    sc_out< sc_logic > Out_I_6_ce1;
    sc_out< sc_logic > Out_I_6_we1;
    sc_out< sc_lv<32> > Out_I_6_d1;
    sc_signal< sc_logic > ap_var_for_const0;


    // Module declarations
    fft_stage_182(sc_module_name name);
    SC_HAS_PROCESS(fft_stage_182);
    ...
    fft_faddfsub_32nslbW<1,4,32,32,32>* fft_faddfsub_32nslbW_U104;
    fft_faddfsub_32nslbW<1,4,32,32,32>* fft_faddfsub_32nslbW_U105;
    fft_fadd_32ns_32nmb6<1,4,32,32,32>* fft_fadd_32ns_32nmb6_U106;
    fft_fadd_32ns_32nmb6<1,4,32,32,32>* fft_fadd_32ns_32nmb6_U107;
    fft_fmul_32ns_32nncg<1,3,32,32,32>* fft_fmul_32ns_32nncg_U108;
    fft_fmul_32ns_32nncg<1,3,32,32,32>* fft_fmul_32ns_32nncg_U109;
    fft_fmul_32ns_32nncg<1,3,32,32,32>* fft_fmul_32ns_32nncg_U110;
    fft_fptrunc_64ns_ocq<1,2,64,32>* fft_fptrunc_64ns_ocq_U111;
    fft_fptrunc_64ns_ocq<1,2,64,32>* fft_fptrunc_64ns_ocq_U112;
    fft_fpext_32ns_64pcA<1,2,32,64>* fft_fpext_32ns_64pcA_U113;
    ...
    sc_signal< sc_lv<22> > tmp_15_fu_312_p4;
    ...
    static const sc_lv<32> ap_const_lv32_BDC90FDB;
    ...
    void thread_Out_I_6_address0();
    void thread_Out_I_6_address1();
    void thread_Out_I_6_ce0();
    void thread_Out_I_6_ce1();
    void thread_Out_I_6_d0();
    void thread_Out_I_6_d1();
    void thread_Out_I_6_we0();
    void thread_Out_I_6_we1();
    void thread_Out_R_6_address0();
    void thread_Out_R_6_address1();
    void thread_Out_R_6_ce0();
    void thread_Out_R_6_ce1();
    void thread_Out_R_6_d0();
    void thread_Out_R_6_d1();
    void thread_Out_R_6_we0();
    void thread_Out_R_6_we1();
    void thread_X_I_5_address0();
    void thread_X_I_5_ce0();
    void thread_X_R_5_address0();
    void thread_X_R_5_ce0();
