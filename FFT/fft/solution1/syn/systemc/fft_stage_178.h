...
#ifndef _fft_stage_178_HH_
#define _fft_stage_178_HH_
...
struct fft_stage_178 : public sc_module {
    ...
    sc_out< sc_lv<10> > X_R_1_address0;
    sc_out< sc_logic > X_R_1_ce0;
    sc_in< sc_lv<32> > X_R_1_q0;
    sc_out< sc_lv<10> > X_I_1_address0;
    sc_out< sc_logic > X_I_1_ce0;
    sc_in< sc_lv<32> > X_I_1_q0;
    sc_out< sc_lv<10> > Out_R_2_address0;
    sc_out< sc_logic > Out_R_2_ce0;
    sc_out< sc_logic > Out_R_2_we0;
    sc_out< sc_lv<32> > Out_R_2_d0;
    sc_out< sc_lv<10> > Out_R_2_address1;
    sc_out< sc_logic > Out_R_2_ce1;
    sc_out< sc_logic > Out_R_2_we1;
    sc_out< sc_lv<32> > Out_R_2_d1;
    sc_out< sc_lv<10> > Out_I_2_address0;
    sc_out< sc_logic > Out_I_2_ce0;
    sc_out< sc_logic > Out_I_2_we0;
    sc_out< sc_lv<32> > Out_I_2_d0;
    sc_out< sc_lv<10> > Out_I_2_address1;
    sc_out< sc_logic > Out_I_2_ce1;
    sc_out< sc_logic > Out_I_2_we1;
    sc_out< sc_lv<32> > Out_I_2_d1;
    sc_signal< sc_logic > ap_var_for_const0;


    // Module declarations
    fft_stage_178(sc_module_name name);
    SC_HAS_PROCESS(fft_stage_178);
    ...
    fft_faddfsub_32nslbW<1,4,32,32,32>* fft_faddfsub_32nslbW_U48;
    fft_faddfsub_32nslbW<1,4,32,32,32>* fft_faddfsub_32nslbW_U49;
    fft_fadd_32ns_32nmb6<1,4,32,32,32>* fft_fadd_32ns_32nmb6_U50;
    fft_fadd_32ns_32nmb6<1,4,32,32,32>* fft_fadd_32ns_32nmb6_U51;
    fft_fmul_32ns_32nncg<1,3,32,32,32>* fft_fmul_32ns_32nncg_U52;
    fft_fmul_32ns_32nncg<1,3,32,32,32>* fft_fmul_32ns_32nncg_U53;
    fft_fmul_32ns_32nncg<1,3,32,32,32>* fft_fmul_32ns_32nncg_U54;
    fft_fptrunc_64ns_ocq<1,2,64,32>* fft_fptrunc_64ns_ocq_U55;
    fft_fptrunc_64ns_ocq<1,2,64,32>* fft_fptrunc_64ns_ocq_U56;
    fft_fpext_32ns_64pcA<1,2,32,64>* fft_fpext_32ns_64pcA_U57;
    ...
    sc_signal< sc_lv<2> > j_fu_306_p2;
    sc_signal< sc_lv<2> > j_reg_360;
    ...
    sc_signal< sc_lv<32> > i_11_fu_346_p2;
    sc_signal< sc_lv<32> > i_11_reg_448;
    ...
    sc_signal< sc_lv<22> > tmp_19_fu_312_p4;
    ...
    void thread_Out_I_2_address0();
    void thread_Out_I_2_address1();
    void thread_Out_I_2_ce0();
    void thread_Out_I_2_ce1();
    void thread_Out_I_2_d0();
    void thread_Out_I_2_d1();
    void thread_Out_I_2_we0();
    void thread_Out_I_2_we1();
    void thread_Out_R_2_address0();
    void thread_Out_R_2_address1();
    void thread_Out_R_2_ce0();
    void thread_Out_R_2_ce1();
    void thread_Out_R_2_d0();
    void thread_Out_R_2_d1();
    void thread_Out_R_2_we0();
    void thread_Out_R_2_we1();
    void thread_X_I_1_address0();
    void thread_X_I_1_ce0();
    void thread_X_R_1_address0();
    void thread_X_R_1_ce0();
