...
#ifndef _fft_stage_181_HH_
#define _fft_stage_181_HH_
...
struct fft_stage_181 : public sc_module {
    ...
    // Module declarations
    fft_stage_181(sc_module_name name);
    SC_HAS_PROCESS(fft_stage_181);
    ...
    fft_faddfsub_32nslbW<1,4,32,32,32>* fft_faddfsub_32nslbW_U90;
    fft_faddfsub_32nslbW<1,4,32,32,32>* fft_faddfsub_32nslbW_U91;
    fft_fadd_32ns_32nmb6<1,4,32,32,32>* fft_fadd_32ns_32nmb6_U92;
    fft_fadd_32ns_32nmb6<1,4,32,32,32>* fft_fadd_32ns_32nmb6_U93;
    fft_fmul_32ns_32nncg<1,3,32,32,32>* fft_fmul_32ns_32nncg_U94;
    fft_fmul_32ns_32nncg<1,3,32,32,32>* fft_fmul_32ns_32nncg_U95;
    fft_fmul_32ns_32nncg<1,3,32,32,32>* fft_fmul_32ns_32nncg_U96;
    fft_fptrunc_64ns_ocq<1,2,64,32>* fft_fptrunc_64ns_ocq_U97;
    fft_fptrunc_64ns_ocq<1,2,64,32>* fft_fptrunc_64ns_ocq_U98;
    fft_fpext_32ns_64pcA<1,2,32,64>* fft_fpext_32ns_64pcA_U99;
    ...
    sc_signal< sc_lv<5> > j_fu_306_p2;
    sc_signal< sc_lv<5> > j_reg_360;
    ...
    sc_signal< sc_lv<32> > i_8_fu_346_p2;
    sc_signal< sc_lv<32> > i_8_reg_448;
    ...
    sc_signal< sc_lv<22> > tmp_16_fu_312_p4;
    ...
    static const sc_lv<32> ap_const_lv32_BE490FDB;
