...
#ifndef _fft_stage_184_HH_
#define _fft_stage_184_HH_
...
struct fft_stage_184 : public sc_module {
    ...
    // Module declarations
    fft_stage_184(sc_module_name name);
    SC_HAS_PROCESS(fft_stage_184);
    ...
    fft_faddfsub_32nslbW<1,4,32,32,32>* fft_faddfsub_32nslbW_U132;
    fft_faddfsub_32nslbW<1,4,32,32,32>* fft_faddfsub_32nslbW_U133;
    fft_fadd_32ns_32nmb6<1,4,32,32,32>* fft_fadd_32ns_32nmb6_U134;
    fft_fadd_32ns_32nmb6<1,4,32,32,32>* fft_fadd_32ns_32nmb6_U135;
    fft_fmul_32ns_32nncg<1,3,32,32,32>* fft_fmul_32ns_32nncg_U136;
    fft_fmul_32ns_32nncg<1,3,32,32,32>* fft_fmul_32ns_32nncg_U137;
    fft_fmul_32ns_32nncg<1,3,32,32,32>* fft_fmul_32ns_32nncg_U138;
    fft_fptrunc_64ns_ocq<1,2,64,32>* fft_fptrunc_64ns_ocq_U139;
    fft_fptrunc_64ns_ocq<1,2,64,32>* fft_fptrunc_64ns_ocq_U140;
    fft_fpext_32ns_64pcA<1,2,32,64>* fft_fpext_32ns_64pcA_U141;
    ...
    sc_signal< sc_lv<8> > j_fu_306_p2;
    sc_signal< sc_lv<8> > j_reg_360;
    ...
    sc_signal< sc_lv<32> > i_5_fu_346_p2;
    sc_signal< sc_lv<32> > i_5_reg_448;
    ...
    sc_signal< sc_lv<22> > tmp_13_fu_312_p4;
    ...
    static const sc_lv<32> ap_const_lv32_BCC90FDB;
