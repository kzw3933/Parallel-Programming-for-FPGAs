...
// ==============================================================
#ifndef __fft_fpext_32ns_64pcA__HH__
#define __fft_fpext_32ns_64pcA__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(fft_fpext_32ns_64pcA) {
    ...
    SC_CTOR(fft_fpext_32ns_64pcA):  ACMP_fpext_U ("ACMP_fpext_U") {
