...
output   X_I_5_ce0;
input  [31:0] X_I_5_q0;
output  [9:0] Out_R_6_address0;
output   Out_R_6_ce0;
output   Out_R_6_we0;
output  [31:0] Out_R_6_d0;
output  [9:0] Out_R_6_address1;
output   Out_R_6_ce1;
output   Out_R_6_we1;
output  [31:0] Out_R_6_d1;
output  [9:0] Out_I_6_address0;
output   Out_I_6_ce0;
output   Out_I_6_we0;
output  [31:0] Out_I_6_d0;
output  [9:0] Out_I_6_address1;
output   Out_I_6_ce1;
output   Out_I_6_we1;
output  [31:0] Out_I_6_d1;
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state2)) begin
        ...
        zext_ln39_reg_352[5 : 0] <= zext_ln39_fu_296_p1[5 : 0];
    end
end
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state15)) begin
        X_I_5_address0 = sext_ln50_fu_340_p1;
    end else if ((1'b1 == ap_CS_fsm_state8)) begin
        X_I_5_address0 = sext_ln48_fu_334_p1;
    end else begin
        X_I_5_address0 = 'bx;
    end
end
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state15)) begin
        X_R_5_address0 = sext_ln50_fu_340_p1;
    end else if ((1'b1 == ap_CS_fsm_state8)) begin
        X_R_5_address0 = sext_ln48_fu_334_p1;
    end else begin
        X_R_5_address0 = 'bx;
    end
end
...
assign Out_I_6_address0 = sext_ln48_reg_400;

assign Out_I_6_address1 = sext_ln50_reg_432;

assign Out_I_6_d0 = reg_289;

assign Out_I_6_d1 = tmp_5_reg_458;

assign Out_R_6_address0 = sext_ln48_reg_400;

assign Out_R_6_address1 = sext_ln50_reg_432;

assign Out_R_6_d0 = reg_282;

assign Out_R_6_d1 = tmp_6_reg_453;
...
assign i_7_fu_346_p2 = ($signed(i_0_reg_179) + $signed(32'd64));

assign i_lower_fu_328_p2 = ($signed(i_0_reg_179) + $signed(32'd32));

assign icmp_ln39_fu_300_p2 = ((i_reg_168 == 6'd32) ? 1'b1 : 1'b0);

assign icmp_ln46_fu_322_p2 = (($signed(tmp_15_fu_312_p4) < $signed(22'd1)) ? 1'b1 : 1'b0);

assign j_fu_306_p2 = (i_reg_168 + 6'd1);

assign sext_ln48_fu_334_p1 = $signed(i_lower_fu_328_p2);

assign sext_ln50_fu_340_p1 = i_0_reg_179;

assign tmp_15_fu_312_p4 = {{i_0_reg_179[31:10]}};

assign zext_ln39_fu_296_p1 = i_reg_168;

always @ (posedge ap_clk) begin
    zext_ln39_reg_352[31:6] <= 26'b00000000000000000000000000;
end

endmodule //fft_stage_182
