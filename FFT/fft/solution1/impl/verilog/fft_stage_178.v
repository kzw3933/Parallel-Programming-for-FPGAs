...
wire   [31:0] i_11_fu_346_p2;
reg   [31:0] i_11_reg_448;
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state2)) begin
        ...
        zext_ln39_reg_352[1 : 0] <= zext_ln39_fu_296_p1[1 : 0];
    end
end
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state15)) begin
        X_I_1_address0 = sext_ln50_fu_340_p1;
    end else if ((1'b1 == ap_CS_fsm_state8)) begin
        X_I_1_address0 = sext_ln48_fu_334_p1;
    end else begin
        X_I_1_address0 = 'bx;
    end
end
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state15)) begin
        X_R_1_address0 = sext_ln50_fu_340_p1;
    end else if ((1'b1 == ap_CS_fsm_state8)) begin
        X_R_1_address0 = sext_ln48_fu_334_p1;
    end else begin
        X_R_1_address0 = 'bx;
    end
end
...
assign Out_I_2_address0 = sext_ln48_reg_400;

assign Out_I_2_address1 = sext_ln50_reg_432;

assign Out_I_2_d0 = reg_289;

assign Out_I_2_d1 = tmp_5_reg_458;

assign Out_R_2_address0 = sext_ln48_reg_400;

assign Out_R_2_address1 = sext_ln50_reg_432;

assign Out_R_2_d0 = reg_282;

assign Out_R_2_d1 = tmp_6_reg_453;
...
assign i_11_fu_346_p2 = ($signed(i_0_reg_179) + $signed(32'd4));

assign i_lower_fu_328_p2 = ($signed(i_0_reg_179) + $signed(32'd2));

assign icmp_ln39_fu_300_p2 = ((i_reg_168 == 2'd2) ? 1'b1 : 1'b0);

assign icmp_ln46_fu_322_p2 = (($signed(tmp_19_fu_312_p4) < $signed(22'd1)) ? 1'b1 : 1'b0);

assign j_fu_306_p2 = (i_reg_168 + 2'd1);

assign sext_ln48_fu_334_p1 = $signed(i_lower_fu_328_p2);

assign sext_ln50_fu_340_p1 = i_0_reg_179;

assign tmp_19_fu_312_p4 = {{i_0_reg_179[31:10]}};

assign zext_ln39_fu_296_p1 = i_reg_168;

always @ (posedge ap_clk) begin
    zext_ln39_reg_352[31:2] <= 30'b000000000000000000000000000000;
end

endmodule //fft_stage_178
