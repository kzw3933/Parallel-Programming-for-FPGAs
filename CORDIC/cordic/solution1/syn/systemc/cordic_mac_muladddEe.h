...
// ==============================================================
#ifndef __cordic_mac_muladddEe__HH__
#define __cordic_mac_muladddEe__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(cordic_mac_muladddEe) {
    ...
    SC_CTOR(cordic_mac_muladddEe):  simcore_mac_1_U ("simcore_mac_1_U") {
