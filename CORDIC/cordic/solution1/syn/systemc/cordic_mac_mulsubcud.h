...
// ==============================================================
#ifndef __cordic_mac_mulsubcud__HH__
#define __cordic_mac_mulsubcud__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(cordic_mac_mulsubcud) {
    ...
    SC_CTOR(cordic_mac_mulsubcud):  simcore_mac_0_U ("simcore_mac_0_U") {
